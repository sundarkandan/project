      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className={`rounded-2xl p-8 shadow-2xl backdrop-blur border transition-all duration-300 bg-slate-900/80 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <input name="email" type="email" onChange={handleChange} placeholder="youremail@gmail.com" className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-3 focus:border-cyan-500" required />
